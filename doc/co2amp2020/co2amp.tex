...
\begin{figure}[ht]
 \centering
 \includegraphics[width=10cm]{images/gui-input}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=10cm]{images/gui-process}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=10cm]{images/gui-output}
...
where $\widehat{E}(\nu,\rho)$ is the field in the frequency domain, $\mathcal{F}$ and $\mathcal{F}^{-1}$ are the Fourier-transform and inverse-Fourier-transform functions, $\nu$ is the frequency, $\nu_c$ is the central frequency, $n_{g}$ is the group index of refraction, and $\Theta$ is the thickness of the window. The dispersion formulas used for calculating $n_0$ are given in Appendix~\ref{appendix:optical_constants}.
...
The following expressions and values for linear ($n_0$) and nonlinear ($n_2$) refractive indexes are used in the program (wavelength $\lambda$ in the dispersion formulas must be expressed in {\textmu}m):
...
$n_2 = 1\times 10^{-19}$ m$^2$/W at 9.2 {\textmu}m - Preliminary estimate
...
$n_2 = 1.7\times 10^{-19}$ m$^2$/W at 9.2 {\textmu}m - Preliminary estimate
...
$n_2 = 1.2\times 10^{-19}$ m$^2$/W - Preliminary estimate
...
$n_2 = 5.6 \times 10^{-20}$ m$^2$/W at 1.06 {\textmu}m \cite{Sheik-Bahae-1991}
...
$n_2 = 4.38\times 10^{-20}$ m$^2$/W at 1.06 {\textmu}m \cite{Sheik-Bahae-1991}
...
$n_2 = 2.5\times 10^{-19}$ m$^2$/W at 9.2 {\textmu}m - Preliminary estimate
